...
- Used SHAP for feature selection instead of RFE for further analysis and reduced our features to 10 from 15 (Ashna)
- Reorganized our database structure to include several entries per patient to keep track of progress every week using a timestamp (Ashna and Sreevardhan)
